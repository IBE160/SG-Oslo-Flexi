...
- [x] Epic 7: Quality Assurance & UX Excellence
  - [x] Story 7.1: Accessibility Compliance (WCAG 2.1 AA)
    - *Sprint 6 Outcome:* Successfully established automated accessibility testing (axe-core) and remediated core flows (Landing, Auth, Dashboard, Learning).
    - *Follow-up:* Dashboard E2E test is implemented but skipped in CI pending a full-stack test environment (see docs/automation-report-story-7.1.md).
